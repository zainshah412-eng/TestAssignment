object Versions {
    ...
    const val androidTestHilt = "2.40.1"

    const val retrofit = "2.9.0"
    const val gsonConvertor = "2.9.0"
    const val okHttp = "4.9.0"
    const val okHttpIntercepter = "4.9.3"
...
object AndroidTestImplementation {
    ...
    const val hiltTest = "com.google.dagger:hilt-android-testing:${Versions.androidTestHilt}"
...
object Retrofit {
    ...
    const val okHttpInterceptor = "com.squareup.okhttp3:logging-interceptor:${Versions.okHttpIntercepter}"
